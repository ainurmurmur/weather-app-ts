...
const App: FC = () => {
  ...
  return (
    <Layout style={{background: isDayTime ? dayColor : nightColor}} className='container'>
      <Typography.Title style={{color: isDayTime ? "steelblue"  : "wheat"}}>Weather app</Typography.Title>
